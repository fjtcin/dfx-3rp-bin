...
entity csr_enc_inputMatrix_Pipeline_VITIS_LOOP_17_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of csr_enc_inputMatrix_Pipeline_VITIS_LOOP_17_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln17_fu_238_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_V_load_1_load_fu_249_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal icmp_ln17_reg_486 : STD_LOGIC_VECTOR (0 downto 0);
    signal bitcast_ln356_fu_333_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln36_fu_366_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln36_reg_504 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln36_1_fu_372_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln36_1_reg_509 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_V_1_fu_310_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal empty_fu_88 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln36_1_fu_408_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_92 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln17_fu_243_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal L_0_fu_96 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln36_fu_400_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_16_fu_100 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_17_fu_104 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_18_fu_108 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bitcast_ln36_fu_348_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_7_fu_352_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln36_fu_362_p1 : STD_LOGIC_VECTOR (51 downto 0);
    signal or_ln36_fu_384_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln36_fu_388_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln36_fu_394_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    empty_16_fu_100_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    empty_16_fu_100 <= in_r_TDATA(127 downto 96);
                end if;
            end if; 
        end if;
    end process;

    empty_17_fu_104_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    empty_17_fu_104 <= in_r_TDATA(95 downto 64);
                end if;
            end if; 
        end if;
    end process;

    empty_18_fu_108_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    empty_18_fu_108 <= in_r_TDATA(63 downto 32);
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln17_fu_238_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    L_0_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln17_reg_486)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln17_reg_486 = ap_const_lv1_1))) then 
    ...
    add_ln17_fu_243_p2 <= std_logic_vector(unsigned(i_fu_92) + unsigned(ap_const_lv15_1));
    add_ln36_fu_394_p2 <= std_logic_vector(unsigned(empty_fu_88) + unsigned(ap_const_lv32_1));
    and_ln36_fu_388_p2 <= (or_ln36_fu_384_p2 and grp_fu_474_p_dout0);
    ...
    ap_condition_355_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln17_fu_238_p2, p_V_fu_84)
    begin
                ap_condition_355 <= ((p_V_fu_84 = ap_const_lv2_0) and (icmp_ln17_fu_238_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_fu_238_p2, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln17_fu_238_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_data_V_2_phi_fu_165_p8_assign_proc : process(icmp_ln17_fu_238_p2, p_V_load_1_load_fu_249_p1, ap_phi_reg_pp0_iter1_data_V_2_reg_162, tmp_num0_fu_257_p1, p_V_fu_84, empty_16_fu_100, empty_17_fu_104, empty_18_fu_108)
    begin
        if ((icmp_ln17_fu_238_p2 = ap_const_lv1_0)) then
            if ((p_V_load_1_load_fu_249_p1 = ap_const_lv2_2)) then 
                ap_phi_mux_data_V_2_phi_fu_165_p8 <= empty_17_fu_104;
            elsif ((p_V_load_1_load_fu_249_p1 = ap_const_lv2_1)) then 
            ...
            elsif ((p_V_load_1_load_fu_249_p1 = ap_const_lv2_3)) then 
    ...
    ap_predicate_op40_read_state2_assign_proc : process(icmp_ln17_fu_238_p2, p_V_fu_84)
    begin
                ap_predicate_op40_read_state2 <= ((p_V_fu_84 = ap_const_lv2_0) and (icmp_ln17_fu_238_p2 = ap_const_lv1_0));
    end process;
    ...
    bitcast_ln36_fu_348_p1 <= grp_fu_471_p_dout0;
    ...
    icmp_ln17_fu_238_p2 <= "1" when (i_cast_fu_234_p1 = mul) else "0";
    icmp_ln36_1_fu_372_p2 <= "1" when (trunc_ln36_fu_362_p1 = ap_const_lv52_0) else "0";
    icmp_ln36_fu_366_p2 <= "0" when (tmp_7_fu_352_p4 = ap_const_lv11_7FF) else "1";
    ...
    matrix_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_fu_238_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln17_fu_238_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    or_ln36_fu_384_p2 <= (icmp_ln36_reg_504 or icmp_ln36_1_reg_509);
    p_Result_s_fu_325_p3 <= (ap_const_lv1_0 & trunc_ln368_fu_321_p1);
    p_V_1_fu_310_p2 <= std_logic_vector(unsigned(p_V_fu_84) + unsigned(ap_const_lv2_1));
    p_V_load_1_load_fu_249_p1 <= p_V_fu_84;
    select_ln36_1_fu_408_p3 <= 
        add_ln36_fu_394_p2 when (and_ln36_fu_388_p2(0) = '1') else 
        empty_fu_88;
    select_ln36_fu_400_p3 <= 
        add_ln36_fu_394_p2 when (and_ln36_fu_388_p2(0) = '1') else 
        L_0_fu_96;
    tmp_7_fu_352_p4 <= bitcast_ln36_fu_348_p1(62 downto 52);
    tmp_num0_fu_257_p1 <= in_r_TDATA(32 - 1 downto 0);
    trunc_ln368_fu_321_p1 <= ap_phi_mux_data_V_2_phi_fu_165_p8(31 - 1 downto 0);
    trunc_ln36_fu_362_p1 <= bitcast_ln36_fu_348_p1(52 - 1 downto 0);
end behav;
