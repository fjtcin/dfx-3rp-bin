...
wire   [31:0] trunc_ln145_fu_79_p1;
wire   [31:0] tmp2_fu_88_p4;
wire   [31:0] tmp_s_fu_103_p4;
wire   [31:0] tmp_1_fu_118_p4;
...
twice_fmul_32ns_32ns_32_3_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
always @ (*) begin
    if ((~((out_r_TREADY_int_regslice == 1'b0) | (regslice_both_out_r_U_apdone_blk == 1'b1)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state3) & (out_r_TREADY_int_regslice == 1'b1)) | (~((in_r_TVALID_int_regslice == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)))) begin
        grp_fu_59_ce = 1'b1;
    end else begin
        grp_fu_59_ce = 1'b0;
    end
...
always @ (*) begin
    ap_block_state4 = ((out_r_TREADY_int_regslice == 1'b0) | (regslice_both_out_r_U_apdone_blk == 1'b1));
end
...
assign bitcast_ln174_1_fu_137_p1 = grp_fu_64_p2;

assign bitcast_ln174_2_fu_141_p1 = grp_fu_69_p2;

assign bitcast_ln174_3_fu_145_p1 = grp_fu_74_p2;

assign bitcast_ln174_fu_133_p1 = grp_fu_59_p2;

assign grp_fu_59_p0 = trunc_ln145_fu_79_p1;

assign grp_fu_64_p0 = tmp2_fu_88_p4;

assign grp_fu_69_p0 = tmp_s_fu_103_p4;

assign grp_fu_74_p0 = tmp_1_fu_118_p4;

assign in_r_TREADY = regslice_both_in_r_U_ack_in;

assign out_r_TDATA_int_regslice = {{{{bitcast_ln174_3_fu_145_p1}, {bitcast_ln174_2_fu_141_p1}}, {bitcast_ln174_1_fu_137_p1}}, {bitcast_ln174_fu_133_p1}};

assign out_r_TVALID = regslice_both_out_r_U_vld_out;

assign tmp2_fu_88_p4 = {{in_r_TDATA_int_regslice[63:32]}};

assign tmp_1_fu_118_p4 = {{in_r_TDATA_int_regslice[127:96]}};

assign tmp_s_fu_103_p4 = {{in_r_TDATA_int_regslice[95:64]}};

assign trunc_ln145_fu_79_p1 = in_r_TDATA_int_regslice[31:0];


reg find_kernel_block = 0;
// synthesis translate_off
`include "twice_hls_deadlock_kernel_monitor_top.vh"
