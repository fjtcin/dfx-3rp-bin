...
module coo_enc_inputMatrix_Pipeline_VITIS_LOOP_16_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] p_V_load_2_load_fu_249_p1;
...
reg   [0:0] icmp_ln16_reg_486;
wire   [31:0] bitcast_ln356_fu_333_p1;
wire   [0:0] icmp_ln35_fu_366_p2;
reg   [0:0] icmp_ln35_reg_504;
wire   [0:0] icmp_ln35_1_fu_372_p2;
reg   [0:0] icmp_ln35_1_reg_509;
...
reg   [1:0] p_V_fu_84;
wire   [1:0] p_V_3_fu_310_p2;
wire    ap_loop_init;
reg   [31:0] empty_fu_88;
wire   [31:0] select_ln35_1_fu_408_p3;
reg   [14:0] i_fu_92;
wire   [14:0] add_ln16_fu_243_p2;
reg   [31:0] L_0_fu_96;
wire   [31:0] select_ln35_fu_400_p3;
reg   [31:0] empty_15_fu_100;
reg   [31:0] empty_16_fu_104;
reg   [31:0] empty_17_fu_108;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] i_cast_fu_234_p1;
wire   [30:0] trunc_ln368_fu_321_p1;
wire   [31:0] p_Result_s_fu_325_p3;
wire   [63:0] bitcast_ln35_fu_348_p1;
wire   [10:0] tmp_4_fu_352_p4;
wire   [51:0] trunc_ln35_fu_362_p1;
wire   [0:0] or_ln35_fu_384_p2;
wire   [0:0] and_ln35_fu_388_p2;
wire   [31:0] add_ln35_fu_394_p2;
reg    grp_fu_175_ce;
reg    grp_fu_178_ce;
...
coo_enc_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            empty_15_fu_100 <= {{in_r_TDATA[127:96]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            empty_16_fu_104 <= {{in_r_TDATA[95:64]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            empty_17_fu_108 <= {{in_r_TDATA[63:32]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_92 <= 15'd0;
        end else if (((icmp_ln16_fu_238_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln16_reg_486 == 1'd1))) begin
        L_0_out_ap_vld = 1'b1;
    end else begin
        L_0_out_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln16_fu_238_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln16_fu_238_p2 == 1'd0)) begin
        if ((p_V_load_2_load_fu_249_p1 == 2'd2)) begin
            ap_phi_mux_data_V_2_phi_fu_165_p8 = empty_16_fu_104;
        end else if ((p_V_load_2_load_fu_249_p1 == 2'd1)) begin
        ...
        end else if ((p_V_load_2_load_fu_249_p1 == 2'd3)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln16_fu_238_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        matrix_we0 = 1'b1;
    end else begin
        matrix_we0 = 1'b0;
    end
...
assign add_ln16_fu_243_p2 = (i_fu_92 + 15'd1);

assign add_ln35_fu_394_p2 = (empty_fu_88 + 32'd1);

assign and_ln35_fu_388_p2 = (or_ln35_fu_384_p2 & grp_fu_474_p_dout0);
...
always @ (*) begin
    ap_condition_355 = ((p_V_fu_84 == 2'd0) & (icmp_ln16_fu_238_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op40_read_state2 = ((p_V_fu_84 == 2'd0) & (icmp_ln16_fu_238_p2 == 1'd0));
end

assign bitcast_ln356_fu_333_p1 = p_Result_s_fu_325_p3;

assign bitcast_ln35_fu_348_p1 = grp_fu_471_p_dout0;
...
assign icmp_ln16_fu_238_p2 = ((i_cast_fu_234_p1 == mul) ? 1'b1 : 1'b0);

assign icmp_ln35_1_fu_372_p2 = ((trunc_ln35_fu_362_p1 == 52'd0) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_366_p2 = ((tmp_4_fu_352_p4 != 11'd2047) ? 1'b1 : 1'b0);

assign matrix_address0 = i_cast1_fu_252_p1;

assign matrix_d0 = ap_phi_mux_data_V_2_phi_fu_165_p8;

assign or_ln35_fu_384_p2 = (icmp_ln35_reg_504 | icmp_ln35_1_reg_509);

assign p_Result_s_fu_325_p3 = {{1'd0}, {trunc_ln368_fu_321_p1}};

assign p_V_3_fu_310_p2 = (p_V_fu_84 + 2'd1);

assign p_V_load_2_load_fu_249_p1 = p_V_fu_84;

assign select_ln35_1_fu_408_p3 = ((and_ln35_fu_388_p2[0:0] == 1'b1) ? add_ln35_fu_394_p2 : empty_fu_88);

assign select_ln35_fu_400_p3 = ((and_ln35_fu_388_p2[0:0] == 1'b1) ? add_ln35_fu_394_p2 : L_0_fu_96);

assign tmp_4_fu_352_p4 = {{bitcast_ln35_fu_348_p1[62:52]}};

assign tmp_num0_fu_257_p1 = in_r_TDATA[31:0];

assign trunc_ln35_fu_362_p1 = bitcast_ln35_fu_348_p1[51:0];

assign trunc_ln368_fu_321_p1 = ap_phi_mux_data_V_2_phi_fu_165_p8[30:0];

endmodule //coo_enc_inputMatrix_Pipeline_VITIS_LOOP_16_1
